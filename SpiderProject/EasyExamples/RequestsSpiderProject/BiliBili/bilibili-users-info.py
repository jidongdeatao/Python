...
for m in range(5214, 5215):
    ...
    def getsource(url):
        ...
        #FROM HERE I REPLACE THE REQUESTS 
        #jscontent = #requests \
            #.session() \
        ...
        jscontent = requests.session().post('http://space.bilibili.com/ajax/member/GetInfo',headers=head,data=payload).text
            ...
            if statusJson == True:
                ...
                try:
                    ...
                    conn = pymysql.connect(
                        host='localhost', user='root', passwd='123212', db='bilibili', charset='utf8')
                    cur = conn.cursor()
